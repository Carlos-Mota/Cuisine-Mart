...
//	@After("execution(* com.cusine_mart.user.service.Implementation.*.save(..))&&args(user)")
	...
	public String traceSignupMethod(JoinPoint joinPoint,User user)throws Throwable{
		String successMsg = "You have successfully signed up in to the system. Please confirm your email by click on following link "+"http://localhost:8080/user/verify/"+user.getUsername();
